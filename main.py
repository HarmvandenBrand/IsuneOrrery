...
def get_isune_cosmology():
    ...
    baruta = Plane("Baruta", amplitude=INNER_PLANES_AMPLITUDE, period_in_hours=PERIOD_IN_HOURS_MATERIAL_PLANES, phase=7/8, color="#8c06ad", size=7)
    ...
    # Outer planes
    mount_delestia = Plane("Mount Delestia", amplitude=OUTER_PLANES_AMPLITUDE, period_in_hours=PERIOD_IN_HOURS_MATERIAL_PLANES, phase=2 / 8, color=OUTER_PLANES_COLOR, size=OUTER_PLANES_SIZE)
    elysium = Plane("Elysium",               amplitude=OUTER_PLANES_AMPLITUDE, period_in_hours=PERIOD_IN_HOURS_MATERIAL_PLANES, phase=3 / 8, color=OUTER_PLANES_COLOR, size=OUTER_PLANES_SIZE)
    the_beastlands = Plane("The Beastlands", amplitude=OUTER_PLANES_AMPLITUDE, period_in_hours=PERIOD_IN_HOURS_MATERIAL_PLANES, phase=4 / 8, color=OUTER_PLANES_COLOR, size=OUTER_PLANES_SIZE)
    limbo = Plane("Limbo",                   amplitude=OUTER_PLANES_AMPLITUDE, period_in_hours=PERIOD_IN_HOURS_MATERIAL_PLANES, phase=5 / 8, color=OUTER_PLANES_COLOR, size=OUTER_PLANES_SIZE)
    the_abyss = Plane("The Abyss",           amplitude=OUTER_PLANES_AMPLITUDE, period_in_hours=PERIOD_IN_HOURS_MATERIAL_PLANES, phase=6 / 8, color=OUTER_PLANES_COLOR, size=OUTER_PLANES_SIZE)
    the_nine_hells = Plane("The Nine Hells", amplitude=OUTER_PLANES_AMPLITUDE, period_in_hours=PERIOD_IN_HOURS_MATERIAL_PLANES, phase=7 / 8, color=OUTER_PLANES_COLOR, size=OUTER_PLANES_SIZE)
